...
{
    [CreateAssetMenu(menuName = "Data/Win Conditions/Income")]
    public class IncomeWinConditions : WinCondition
    {
        [field: SerializeField] public float Goal { get; set; }
        [field: SerializeField] public int TurnLimit { get; set; }

        public override string WinDescription => $"Reach {Goal}$ daily income";
        ...
        public override IGameResult Check(IGameState gameState)
        {
            ...
            {
                WinProgress = (gameState.BuildingIncome / Goal),
            ...
            if (gameState.BuildingIncome >= Goal)
                return result.Win();
